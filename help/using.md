---
title: Uso de la aplicación de escritorio de AEM
seo-title: Uso de la aplicación de escritorio Adobe Experience Manager
description: Aprenda a instalar y utilizar la aplicación de escritorio de Adobe Experience Manager para trabajar con recursos AEM directamente desde el escritorio de Windows o Mac. Conozca las prácticas recomendadas y la información de solución de problemas.
seo-description: Aprenda a instalar y utilizar la aplicación de escritorio de Adobe Experience Manager para trabajar con recursos AEM directamente desde el escritorio de Windows o Mac. Conozca las prácticas recomendadas y la información de solución de problemas.
...
# Uso de la aplicación de escritorio de AEM {#use-aem-desktop-app-v2}

Utilice la aplicación de escritorio Adobe Experience Manager (AEM) para acceder fácilmente a los recursos de AEM en el escritorio local y utilizar estos recursos en cualquier aplicación de escritorio. Puede abrir los recursos en aplicaciones de escritorio y editarlos localmente; vuelva a cargar los cambios en AEM con control de versiones para compartirlos con otros usuarios. También puede cargar nuevos archivos y jerarquías de carpetas en AEM, crear carpetas y eliminar recursos o carpetas de AEM.

La integración permite que varios roles de la organización gestionen los recursos de forma centralizada en Recursos AEM y accedan a los recursos en el escritorio local en las aplicaciones nativas en Windows o Mac OS.

Cuando abra la aplicación después de cerrar sesión o por primera vez, proporcione la URL de su servidor AEM. Haga clic en Conectar. Proporcione sus credenciales para conectar la aplicación con el servidor.

Las tareas clave que realiza con la aplicación de escritorio de AEM son:

![Flujos de trabajo y tareas que puede realizar con la](assets/do-not-localize/whats-new-desktop-app-v2.png "aplicación de escritorio de AEMFlujos de trabajo y tareas que puede realizar con la aplicación")de escritorio de AEM Descargue [este](assets/do-not-localize/aem_desktop_app_usecases_print.pdf) archivo PDF listo para imprimir.

## Funcionamiento de la aplicación de escritorio {#how-app-works2}

Antes de empezar a usar la aplicación, debe comprender [cómo funciona](release-notes.md#how-app-works)la aplicación. Además, familiarícese con los siguientes términos:
...
* El estado del archivo es **[!UICONTROL Cloud Only]**: Estos recursos no se descargan en el equipo local y solo están disponibles en el servidor AEM.
...
* El estado del archivo es **[!UICONTROL Edited locally]**: Estos recursos se modifican localmente y los cambios permanecen en el servidor AEM cargado. Después de cargar, el estado cambia a [!UICONTROL Available locally]. Consulte [Edición de recursos](using.md#edit-assets-upload-updated-assets).
...
* **[!UICONTROL Open In Web]** acción: Para ver el recurso en la interfaz web de AEM, ábralo en web. Puede iniciar más flujos de trabajo desde la interfaz de AEM, como la actualización de metadatos o la detección de recursos.
...
## Examinar, buscar y obtener una vista previa de recursos {#browse-search-preview-assets}

Puede buscar, buscar y obtener una vista previa de los recursos disponibles en el repositorio de AEM desde la aplicación de escritorio. Pruebe lo siguiente en la aplicación:
...
1. Para ver más información y una miniatura más grande de un recurso individual, haga clic en el nombre del archivo.
   ...
   ![Ver una vista previa más grande de un recurso y](assets/large_preview_actions_da2.png "accionesVer una vista previa más grande de un recurso y de las acciones")

1. Haga clic **[!UICONTROL Open]** o **[!UICONTROL Edit]** para descargar el archivo de forma local y visualizarlo o editarlo en la aplicación nativa, respectivamente.
...
En los siguientes casos, es posible que desee descartar los cambios y las ediciones en el recurso local. Click **[!UICONTROL Discard Changes]**.
...
>[!NOTE]
>
>Si los archivos no se pueden cargar y se está conectando a la implementación de AEM 6.5.1 o posterior, consulte esta información [sobre la](troubleshoot.md#upload-fails)solución de problemas.
...
Para ver la lista de recursos transferidos en una sesión determinada, consulte [Carga de recursos en AEM](#upload-and-add-new-assets-to-aem).

## Flujo de trabajo avanzado: comenzar desde la interfaz web de AEM Assets {#adv-workflow-start-from-aem-ui}
...
En entornos de colaboración, varios usuarios pueden trabajar en el mismo conjunto de recursos que pueden provocar conflictos de versiones. Para evitar conflictos, siga estas optimizaciones:
...
* Haga clic [!UICONTROL Toggle Check-in] si accidentalmente comienza a editar sin hacer clic en [!UICONTROL Edit]. Esto agrega un icono de candado al recurso. Incluso si planea editar un recurso más adelante pero desea evitar que otros lo editen, haga clic en [!UICONTROL Toggle Check-in] para bloquearlo.
...
1. Una vez finalizadas las ediciones en el documento de InDesign, guárdelo y cárguelo en AEM mediante la aplicación de escritorio.
