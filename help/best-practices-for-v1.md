...
>[!NOTE]
>
>Antes de leer este documento, puede revisar las [optimizaciones generales de integración de AEM y Creative Cloud](https://experienceleague.adobe.com/docs/experience-manager-65/assets/administer/aem-cc-integration-best-practices.html) para obtener una visión general de nivel superior del tema.

## Arquitectura de aplicaciones de escritorio AEM {#aem-desktop-app-architecture}
...
* **Acceda al recurso desde el escritorio**. En el recurso compartido de red montado, un menú contextual proporciona un cuadro de diálogo [!UICONTROL More Info] (previsualización más grande, metadatos clave) y la capacidad de abrir un recurso en la interfaz de usuario de AEM.
...
* No utilice AEM aplicación de escritorio para administrar recursos desde el escritorio. AEM aplicación de escritorio no se ha creado como un reemplazo de las unidades de red. En su lugar, utilice las siguientes capacidades:
   ...
   * AEM la aplicación de escritorio [!UICONTROL Folder Upload] para cargar carpetas jerárquicas grandes.
...
* Para **actualizaciones principales**, como una solicitud de cambio que requiere un ciclo de trabajo en curso creativo pequeño:
...
Para comprender cómo se debe optimizar el rendimiento del servidor de AEM Assets, consulte [AEM Assets Performance Tuning Guide](https://experienceleague.adobe.com/docs/experience-manager-65/assets/administer/performance-tuning-guidelines.html). Algunos de los aspectos importantes del rendimiento del servidor para AEM aplicación de escritorio son la optimización de la configuración del flujo de trabajo para que funcione correctamente en las cargas de recursos:

* **Carga** de recursos de mayor rendimiento. Configure el modelo de flujo de trabajo de [Actualización de recursos de AEM para que sea transitorio](https://experienceleague.adobe.com/docs/experience-manager-65/assets/administer/performance-tuning-guidelines.html).
